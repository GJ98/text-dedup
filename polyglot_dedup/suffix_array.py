...
from polyglot_dedup.utils import add_io_args, add_meta_args, add_sa_args
...
if __name__ == "__main__":
    ...
    temp_text = f"{args.google_repo_path}/output/temp_text.txt"
    temp_output = f"{args.google_repo_path}/output/temp_output.txt"
